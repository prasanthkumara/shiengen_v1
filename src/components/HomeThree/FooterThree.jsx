...
const FooterThree = () => {
  return (
    <>
      <footer>
        <div className="footer__area-2 black-bg-2 pt-100">
            ...
            <div className="row">
              <div className="col-xl-4 col-lg-6 col-md-12 col-sm-12">
                <div className="footer__widget footer__col-2 mb-40">
                  ...
                  <div className="footer__subscribe-form footer__subscribe-form-df p-relative mb-30">
                    <form action="#">
                      <input type="email" placeholder="Email Address" />
                      <button
                        type="submit"
                        className="s-button-2 s-button-2-df"
                      >
                        Subscribe
                      </button>
                    </form>
                    ...
                    <div className="footer__post">
                      <div className="footer__post-item pb-20">
                        ...
                        <div className="footer__post-item-content">
                          ...
                          <h5>
                            <Link href="/blog-details">
                              <a>Chip startup says sensors may replace buttons on</a>
                            </Link>
                          </h5>
                        </div>
                      </div>
